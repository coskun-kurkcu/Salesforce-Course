...
import { BookOpen, CheckCircle, ChevronDown, Code, Database, Layout } from 'lucide-react';
...
const modules = [
  ...
  },
  {
    ...
    lessons: [
      'Introduction to LWC & Web Standards',
      'HTML Templates & JavaScript Controllers',
      'Component Communication (Events, PubSub)',
      'Working with Salesforce Data (Wire Service)',
      'Styling with SLDS'
    ]
  }
];
...
export default function Curriculum() {
  ...
  return (
    <section id="curriculum" className="py-24 bg-slate-950 relative border-t border-slate-900">
          ...
          {modules.map((mod, index) => (
            ...
            >
              ...
              >
                ...
                <ChevronDown
                  className={`w-5 h-5 text-slate-400 transition-transform duration-300 ${openModule === index ? 'rotate-180' : ''}`}
                />
              </button>
